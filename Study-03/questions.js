...
const questions = [
  ...
  },
  {
    ...
    choices: ["8월 15일","3월 1일","10월 3일","6월 25일"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["백제, 신라, 발해","신라, 가야, 발해","고구려, 백제, 가야","고구려, 백제, 신라"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["1450년","1446년","1443년","1392년"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["3.1운동","6월 민주항쟁","4.19혁명","5.18민주화운동"],
    answerIndex: 0,
  ...
  // ===== 한국사 - 중 (11~20) =====
  {
    ...
    choices: ["최씨(최충헌) 가문","김씨 가문","왕씨 가문","이씨 가문"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["1884년","1904년","1910년","1894년"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["1650년","1592년","1636년","1627년"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["1608년","1636년","1592년","1598년"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["전주 이씨","경주 이씨","안동 김씨","광산 김씨"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["한성 조약","제물포 조약","시모노세키 조약","강화도 조약"],
    answerIndex: 3,
  ...
  // ===== 한국사 - 최상 (31~40) =====
  {
    ...
    choices: ["황산벌 전투","안시성 전투","살수 대첩","매소성 전투"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["세금 제도 개편","왕실의 상복(복상) 기간","토지 소유 제한","군역 부담 방식"],
    answerIndex: 1,
    explanation: "예송논쟁은 효종과 효종비가 세상을 떠났을 때, 인조의 계비인 자의대비가 입을 상복 기간을 두고 서인과 남인이 벌인 논쟁이에요.",
  },
  {
    id: 39,
    category: "한국사",
  ...
  },
  {
    ...
    choices: ["양극과 음극","N극과 S극","A극과 B극","상극과 하극"],
    answerIndex: 1,
  ...
  // ===== 과학 - 중 (51~60) =====
  {
    ...
    choices: ["양성자와 광자","양성자와 중성자","전자와 중성자","전자와 양성자"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["만유인력의 법칙","제3법칙(작용-반작용)","제2법칙(가속도)","제1법칙(관성)"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["헬리케이스","DNA 중합효소","RNA 중합효소","리가아제"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["1895년","1915년","1905년","1900년"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["우열의 법칙","분리의 법칙","연관의 법칙","독립의 법칙"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["이중슬릿 실험","자유낙하 실험","단진자 실험","전기분해 실험"],
    answerIndex: 0,
  ...
  // ===== 과학 - 최상 (71~80) =====
  {
    ...
    choices: ["상보성 원리","불확정성 원리","파울리 배타 원리","중첩 원리"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["연속 방정식","앙페르-맥스웰 법칙","파라데이 법칙","가우스 법칙"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["진공 상태에서만","특정 임계온도 이하의 매우 낮은 온도","강한 자기장 속에서만","매우 높은 온도"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["시토신(C)","구아닌(G)","우라실(U)","티민(T)"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["파동-입자 이중성","입자의 교환","전자기력","시공간의 휘어짐"],
    answerIndex: 3,
  ...
  },
  {
    ...
    difficulty: "하",
    hasHint: true,
    question: "해발고도 기준으로 세계에서 가장 높은 산은 무엇일까요?",
    choices: ["K2","킬리만자로","에베레스트","몽블랑"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["베니스 영화제","베를린 영화제","선댄스 영화제","칸 영화제"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["앤드루 카네기","헨리 포드","알프레드 노벨","존 록펠러"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["직지심체요절","삼국유사","팔만대장경","동의보감"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["메소포타미아 문명","이집트 문명","마야 문명","황하 문명"],
    answerIndex: 2,
  ...
  // ===== 일반상식 - 상 (101~110) =====
  {
    ...
    choices: ["영토(국경) 안에서의 생산","국적","수출량","인구수"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["로마법대전","함무라비 법전","십계명","마그나 카르타"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["카를 마르크스","밀턴 프리드먼","애덤 스미스","존 메이너드 케인스"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["UN 총회","OECD 총회","G7 정상회의","세계경제포럼"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["프랑스 인권선언","일본 헌법","영국 대헌장","미국 헌법"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["세계 빈곤국 무상 원조","회원국의 국제수지·외환위기 지원","국제 무역 분쟁 재판","전쟁 중재"],
    answerIndex: 1,
  ...
  // ===== 일반상식 - 최상 (111~120) =====
  {
    ...
    choices: ["파리 협약","헤이그 협약","비엔나 협약","제네바 협약"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["상호주의","불간섭 원칙","보편적 관할권","최혜국 대우"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["프리드리히 하이에크","밀턴 프리드먼","애덤 스미스","존 메이너드 케인스"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["존 로크","장 자크 루소","토마스 홉스","몽테스키외"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["약 38.5도","약 40도","약 34도","약 36.5도"],
    answerIndex: 3,
  ...
  // ===== 의학 - 상 (141~150) =====
  {
    ...
    choices: ["굴심방결절","방실결절","퍼킨제 섬유","심실중격"],
    answerIndex: 0,
  ...
  },
  {
    ...
    choices: ["펩신","리파아제","아밀라아제","사이토크롬 P450"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["루이 파스퇴르","로베르트 코흐","에드워드 제너","알렉산더 플레밍"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["불활성화 백신","톡소이드 백신","약독화 생백신","mRNA 백신"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["확장기 혈압","평균 혈압","맥압","수축기 혈압"],
    answerIndex: 3,
  ...
  },
  {
    ...
    choices: ["후천면역(적응면역)","선천면역","수동면역","능동면역"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["제1형 당뇨병","제2형 당뇨병","통풍","갑상선기능저하증"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["낮은 산소 요구량","느린 세포분열","빠른 세포분열","강한 세포막"],
    answerIndex: 2,
  ...
  },
  {
    ...
    choices: ["황색포도상구균","폐렴구균","살모넬라균","대장균"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["중증근무력증","다발성 경화증","루푸스","류마티스 관절염"],
    answerIndex: 1,
  ...
  },
  {
    ...
    choices: ["트로포닌(Troponin)","CK-MB","LDH","AST"],
    answerIndex: 0,
